...
export const ModeSelectionPage: React.FC = () => {
    ...
    const stats = [
        { label: 'Total XP', value: '2,450', icon: Zap, color: 'text-yellow-400', bg: 'bg-yellow-400/10', border: 'border-yellow-400/20' },
        { label: 'Day Streak', value: '5 Days', icon: Flame, color: 'text-orange-400', bg: 'bg-orange-400/10', border: 'border-orange-400/20' },
        { label: 'Time Spent', value: '12.5 Hrs', icon: Clock, color: 'text-blue-400', bg: 'bg-blue-400/10', border: 'border-blue-400/20' },
    ];
    ...
    const modes = [
        ...
        },
        {
            ...
            progress: 45,
            features: ['Spanish (Intermediate)', 'Real-time Feedback'],
            badge: 'In progress',
            active: true,
        },
        {
                ...
                <div className="flex flex-col md:flex-row gap-8 justify-between items-start md:items-end">
                    <AnimatedSection effect="fade-up">
                        <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">
                            Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Explorer</span>
                        </h1>
                        ...
                        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-center sm:text-left">
                                    <h3 className="text-lg font-semibold text-white">Continue Your Conversation</h3>
                                    <p className="text-sm text-gray-400">Last active: Recently • Entertainment Chat</p>
                                </div>
                            </div>
                            <button
